...
TELEGRAM_BOT_TOKEN = os.environ.get("DARITH_TELEGRAM_BOT_TOKEN", "").strip()
TELEGRAM_CHAT_ID = os.environ.get("DARITH_TELEGRAM_CHAT_ID", "").strip()
TELEGRAM_NOTIFICATION_TIMEOUT_SECONDS = float(
    os.environ.get("DARITH_TELEGRAM_TIMEOUT_SECONDS", "3")
)
