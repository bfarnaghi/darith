...
urlpatterns = [
    ...
    path("plans/occurrence/<str:kind>/<int:plan_id>/<str:scheduled_date>/", views.manage_plan_occurrence, name="manage_plan_occurrence"),
    path("spending/check/", views.check_extra_spending, name="check_extra_spending"),
    path("spending/apply/", views.apply_extra_spending_plan, name="apply_extra_spending_plan"),
    path("settings/planning/daily-adjustment/<int:item_id>/remove/", views.remove_daily_spending_adjustment, name="remove_daily_spending_adjustment"),
    path("settings/daily-spending/", views.update_budget_preference, name="update_budget_preference"),
    path("settings/planning/", views.update_planning_settings, name="update_planning_settings"),
    path("settings/account/username/", views.update_username, name="update_username"),
    path("settings/account/password/", views.update_account_password, name="update_account_password"),
